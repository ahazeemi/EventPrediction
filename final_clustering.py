    ...
    for year in range(2017,2018):
        for month in range(1,2):
            for day in range(1,6):
                ...
                fileName = yearStr+monthStr+dayStr+'*.csv'
                file_txt = yearStr+monthStr+dayStr+'.txt'

                path = r'C:\Users\lenovo\PycharmProjects\FYP\filtered_two2'  # use your path
                ...
                with open('final/' + file_txt, 'w', encoding='utf-8') as file:
